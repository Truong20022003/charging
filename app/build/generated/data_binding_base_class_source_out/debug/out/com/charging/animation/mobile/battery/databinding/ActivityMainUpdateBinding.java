...
public final class ActivityMainUpdateBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainUpdateBinding(@NonNull ConstraintLayout rootView,
      @NonNull BlurView blurViewMain, @NonNull CardView bottomBar, @NonNull CardView btnGallery,
      @NonNull CardView btnHome, @NonNull ImageView btnInfo, @NonNull CardView btnSetting,
      @NonNull ImageView img1, @NonNull ImageView img3, @NonNull ImageView img4,
      @NonNull ImageView imgBack, @NonNull FrameLayout include, @NonNull ProgressBar progress,
  ...
  @NonNull
  public static ActivityMainUpdateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainUpdateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_update, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainUpdateBinding((ConstraintLayout) rootView, blurViewMain, bottomBar,
