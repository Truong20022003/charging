...
public final class ActivityApplyAnimationUpdateBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityApplyAnimationUpdateBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityApplyAnimationUpdateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityApplyAnimationUpdateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_apply_animation_update, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityApplyAnimationUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityApplyAnimationUpdateBinding((ConstraintLayout) rootView, blurViewCharging,
