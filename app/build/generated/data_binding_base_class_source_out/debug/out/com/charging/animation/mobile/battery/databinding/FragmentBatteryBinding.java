...
public final class FragmentBatteryBinding implements ViewBinding {
  ...
  private FragmentBatteryBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView connect,
      @NonNull ImageView imageView12, @NonNull ImageView img1, @NonNull ImageView img2,
      @NonNull ImageView img3, @NonNull ImageView img4, @NonNull ImageView img5,
      @NonNull ImageView img6, @NonNull ImageView imgCycle, @NonNull LinearLayout imgPin,
      @NonNull NestedScrollView scrollView2, @NonNull CustomTextView template,
      @NonNull CustomTextView tv1, @NonNull CustomTextView tv2, @NonNull CustomTextView tv3,
      @NonNull CustomTextView tv4, @NonNull CustomTextView tv5, @NonNull CustomTextView tv6,
      @NonNull CustomTextView tvCapacity, @NonNull CustomTextView tvHeart,
      @NonNull CustomTextView tvLion, @NonNull CustomTextView tvPin3,
      @NonNull LinearLayout tvPinInfo, @NonNull CustomTextView tvType,
      @NonNull CustomTextView tvVol) {
  ...
  public static FragmentBatteryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBatteryBinding((ConstraintLayout) rootView, connect, imageView12, img1,
          img2, img3, img4, img5, img6, imgCycle, imgPin, scrollView2, template, tv1, tv2, tv3, tv4,
          tv5, tv6, tvCapacity, tvHeart, tvLion, tvPin3, tvPinInfo, tvType, tvVol);
    }
