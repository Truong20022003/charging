...
public final class FragmentCustomUpdateBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentCustomUpdateBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView btnHome, @NonNull ImageView imgNodata, @NonNull RecyclerView rcvGallery,
  ...
  @NonNull
  public static FragmentCustomUpdateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCustomUpdateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_custom_update, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCustomUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCustomUpdateBinding((ConstraintLayout) rootView, btnHome, imgNodata,
