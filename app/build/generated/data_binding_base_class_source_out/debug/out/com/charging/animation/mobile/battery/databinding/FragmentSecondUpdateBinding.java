...
public final class FragmentSecondUpdateBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentSecondUpdateBinding(@NonNull LinearLayout rootView, @NonNull ImageView connect,
  ...
  @NonNull
  public static FragmentSecondUpdateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSecondUpdateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_second_update, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSecondUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSecondUpdateBinding((LinearLayout) rootView, connect, imageView29,
          imageView30, template, tv1, tv2, tv3, tv4, tvBattery, tvCapacity, tvHeart, tvLion,
          tvPin3);
    }
