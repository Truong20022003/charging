...
public final class ActivitySuccessUpdateBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySuccessUpdateBinding(@NonNull ConstraintLayout rootView, @NonNull View dot1,
  ...
  @NonNull
  public static ActivitySuccessUpdateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySuccessUpdateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_success_update, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySuccessUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySuccessUpdateBinding((ConstraintLayout) rootView, dot1, frAds, gif,
          imageView2, imgRetry, linearLayout11);
    }
