...
public final class FragmentDownBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentDownBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnHome,
  ...
  @NonNull
  public static FragmentDownBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentDownBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_down, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDownBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDownBinding((ConstraintLayout) rootView, btnHome, imgNodata, rcvGallery,
          rootNodata, tvTitle);
    }
