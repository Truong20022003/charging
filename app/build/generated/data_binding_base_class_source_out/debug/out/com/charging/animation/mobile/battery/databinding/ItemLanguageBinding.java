...
public final class ItemLanguageBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout rootLanguage;

  @NonNull
  public final TextView tvTitle;

  private ItemLanguageBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgIcon,
      @NonNull ConstraintLayout rootLanguage, @NonNull TextView tvTitle) {
  ...
  public static ItemLanguageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rootLanguage;
      ConstraintLayout rootLanguage = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemLanguageBinding((ConstraintLayout) rootView, imgIcon, rootLanguage, tvTitle);
    }
