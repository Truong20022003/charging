...
public class HighService extends Service {
    ...
    private void showNotification() {
        ...
        Intent mMainIntent = new Intent(getBaseContext(), HighReceiver.class);
        mMainIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);

        PendingIntent mMainPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 2002, mMainIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        RemoteViews contentView = new RemoteViews(getApplicationContext().getPackageName(), R.layout.service_full_batter);
        contentView.setTextViewText(R.id.tvTitle, getString(R.string.temperature_greater_than_60_degrees_celsius_tap_to_stop_ringtone));
    ...
    private String createNotificationChannel(NotificationManager notificationManager) {
        ...
        String channelName = "Charging service high";
